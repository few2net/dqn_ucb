"""
    ...
    This version also add bias at D network and take relu function to D value at decision of U
...
class Model(object):
    def __init__(self, num_actions, death_constant, risk_constant, sess=None, multi_gpu=False, no_gpu=False):
        ...
        u_t_selected_target = q_t_selected_target - (b * tf.nn.relu(d_t_selected_target))
